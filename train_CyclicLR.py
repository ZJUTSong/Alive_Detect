...
def run_test(config, dir):
    ...
    valid_loss,out,time_cost = do_valid_test(net, valid_loader, criterion)
    print(AsciiTable([
            ['metric', 'value'],
            ['val_loss', valid_loss[0]],
            ['val_acer', valid_loss[1]],
            ['val_acc', valid_loss[2]],
            ['val_correct', valid_loss[3]],
        ]).table)
